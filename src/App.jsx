...
const plans = [
  { name: "Launch", price: "₹8,999", description: "For a sharp, focused first impression.", features: ["One-page website", "Custom visual direction", "Responsive development", "Basic SEO setup"], featured: false },
  { name: "Signature", price: "₹15,999", description: "For brands ready to look established.", features: ["Up to 5 strategic pages", "Premium custom design", "Conversion-focused copy structure", "Speed & SEO optimisation", "30 days support"], featured: true },
  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="section contact-section" id="contact"><div className="contact-layout"><div className="contact-copy"><p className="section-kicker">Your turn <span>06</span></p><h2>Have a good<br /><em>feeling?</em></h2><p>Tell us a little about what you are building. We will get back to you within 24 hours with a clear next step.</p><div className="contact-details">
  <a href="mailto:mishraswastik1711@gmail.com">
    mishraswastik1711@gmail.com <ArrowUpRight size={14} />
  </a>

  <span>Mohali, Punjab · Working worldwide</span>
